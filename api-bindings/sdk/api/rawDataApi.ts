...
import { GetAILabelingPreviewRequest } from '../model/getAILabelingPreviewRequest';
...
export class RawDataApi {
    ...
    /**
     * Get a number of random samples to show in the AI Labeling screen
     * @summary Preview samples for AI Labeling
     * @param projectId Project ID
     * @param getAILabelingPreviewRequest 
     */
    public async previewAILabelingSamples (projectId: number, getAILabelingPreviewRequest: GetAILabelingPreviewRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListSamplesResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/raw-data/ai-labeling-preview'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'edgeimpulse-api nodejs'
        ...
        if (projectId === null || projectId === undefined) {
            throw new Error('Required parameter projectId was null or undefined when calling previewAILabelingSamples.');
        }

        // verify required parameter 'getAILabelingPreviewRequest' is not null or undefined


        if (getAILabelingPreviewRequest === null || getAILabelingPreviewRequest === undefined) {
            throw new Error('Required parameter getAILabelingPreviewRequest was null or undefined when calling previewAILabelingSamples.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            agentOptions: {keepAlive: false},
            json: true,
            body: ObjectSerializer.serialize(getAILabelingPreviewRequest, "GetAILabelingPreviewRequest")
        };
    ...
    /**
     * Queue up changes to an object as part of the AI Labeling flow. This overwrites any previous proposed changes.

...
import { GetAILabelingConfigResponse } from '../model/getAILabelingConfigResponse';
...
export class ProjectsApi {
    ...
    /**
     * Get the last used AI Labeling config
     * @summary Get AI Labeling config
     * @param projectId Project ID
     */
    public async getAILabelingConfig (projectId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetAILabelingConfigResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/ai-labeling'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'edgeimpulse-api nodejs'
        ...
        if (projectId === null || projectId === undefined) {
            throw new Error('Required parameter projectId was null or undefined when calling getAILabelingConfig.');
        }
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<GetAILabelingConfigResponse>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetAILabelingConfigResponse");
